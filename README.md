...
| TF1 | 27/06/2024 | Calisaya Sánchez, Juan Jesús<br></br> Gallo Quintana, David Ivanoff<br></br> Huarcaya Quispe, Niurka Lucero<br></br><br> Oneglio De Paz, Beth Shantal | Adición del Capítulo: 5.2.4., 5.2.4.1., 5.2.4.2., 5.2.4.3., 5.2.4.4., 5.2.4.5., 5.2.4.6., 5.2.4.7., 5.2.4.8. Conclusiones. |
...
**TB2**: Las tareas asignadas para la entrega del TB2 han sido completadas y debidamente documentadas en el repositorio de GitHub del equipo. [https://github.com/upc-pre-202401-si720-si91-Ruedarent/Ruedarent-Report/tree/release](https://github.com/upc-pre-202401-si720-si91-Ruedarent/Ruedarent-Report/tree/release).
...
- Se llevaron a cabo reuniones para coordinar el avance de los elementos del informe y comunicar los progresos del Sprint 3, enfocado en el desarrollo del frontend y avance de la API.

<a href="https://ibb.co/dW3DJz0"><img src="https://i.ibb.co/smDqJMv/image.png" alt="image" border="0"></a>
<a href="https://ibb.co/mbqZZnK"><img src="https://i.ibb.co/6rP99KS/image.png" alt="image" border="0"></a>
<a href="https://ibb.co/sHc0JyL"><img src="https://i.ibb.co/C24kshx/image.png" alt="image" border="0"></a>
<a href="https://ibb.co/Bg8R3Zh"><img src="https://i.ibb.co/zSKwxR3/image.png" alt="image" border="0"></a>
<img src="https://i.ibb.co/L5nr86z/image.png" alt="image" border="0"></a>
<a href="https://ibb.co/gwt9wZC"><img src="https://i.ibb.co/K7Vh7xH/image.png" alt="image" border="0"></a>

<img src="https://i.ibb.co/L5nr86z/image.png" alt="image" border="0"></a>

TF1: Las tareas asignadas para la entrega del TF1 se han completado y documentado en el repositorio de GitHub del equipo.

Cada integrante redactó y diagramó los contenidos asignados en formato Markdown, realizando commits para asegurar el seguimiento del progreso en el repositorio. Se crearon los artefactos necesarios utilizando las herramientas recomendadas. Se llevaron a cabo reuniones para coordinar el avance de los elementos del informe y comunicar los progresos del Sprint 3, centrado en finalizar el desarrollo de la API y proceder a su despliegue.

<a href="https://ibb.co/7pxwTf8"><img src="https://i.ibb.co/LgDLqFb/image.png" alt="image" border="0"></a>
...
<table>
  ...
  <tr>
    <td>Ventaja competitiva<br>¿Qué valor ofrece a los clientes</td><td text-align= "justify">Facilita la movilidad urbana al conectar usuarios con vehículos eléctricos disponibles para alquilar.</td><td text-align= "justify">Garantiza acceso rápido a destinos urbanos clave en 15 minutos con una movilidad inteligente y asequible.</td><td text-align= "justify">Conecta viajeros con anfitriones locales, ofreciendo una amplia variedad de alojamientos en todo el mundo.</td><td text-align= "justify">Proporciona una solución de movilidad sostenible en Miraflores, Lima, a través de bicicletas públicas</td>
  </tr>
  <tr>
    <td rowspan=2>Perfil de Marketing</td><td>Mercado objetivo</td><td text-align= "justify">Propietarios y personas interesados en la movilidad flexible y sostenible.</td><td text-align= "justify">Residentes urbanos que valoran la convivencia y rapidez en sus desplazamientos.</td><td text-align= "justify">Viajeros que buscan opciones de alojamiento únicas y auténticas en todo el mundo.</td><td text-align= "justify">Residentes y visitantes de Miraflores, Lima, interesados en una movilidad sostenible y activa.</td>
  </tr>
  <tr>
    <td>Estrategias de marketing</td><td text-align= "justify">Marketing en redes sociales dirigido a urbanistas preocupados por el medio ambiente y la movilidad sostenible.</td><td text-align= "justify">Campañas de marketing enfocadas en la accesibilidad y rapides de llegar a destinos clave en la ciudad.</td><td text-align= "justify">Estrategias de contenido en redes sociales que resalten experiencias únicas y testimonios de viajeros satisfechos.</td><td text-align= "justify">Ofertas especiales y descuentos para residentes locales que se registren en el servicio.</td>
  </tr>
  <tr>
    <td rowspan=3>Perfil del Producto</td><td>Productos & Servicios</td><td text-align= "justify">- Plataforma web y/o aplicación móvil para alquiler de vehículos eléctricos.<br>- Diversidad de vehículos eléctricos disponibles para alquilar, como bicicletas, scooters, skateboards, entre otros.<br>- Opciones de reserva y pago en línea para una experiencia conveniente.</td><td text-align= "justify">- Aplicación móvil que ofrece rutas y horarios para garantizar llegar a destinos clave en la ciudad en un máximo de 15 minutos.<br>- Sistema de geolocalización que muestra las estaciones de transporte y las opciones disponibles en tiempo real.<br>- Tarifas de suscripción o pago por uso para acceder al servicio.</td><td text-align= "justify">- Plataforma web y aplicación móvil para búsqueda, reserva y gestión de alojamientos.<br>- Amplia variedad de opciones de alojamiento, que incluyen desde habitaciones privadas hasta casas enteras y experiencias únicas.<br>- Sistema de revisión y calificación para garantizar la confianza y seguridad de los usuarios.</td><td text-align= "justify">- Red de estaciones de bicicletas públicas distribuidas estratégicamente en el distrito de Miraflores.<br>- Bicicletas disponibles para alquiler a través de un sistema automatizado en las estaciones.<br>- Tarifas de alquiler por período de tiempo, como por hora o por día.</td>
   </tr>
   <tr>
   ...
   <tr>
    <td>Canales de distribución (Web y/o Móvil)</td><td text-align= "justify">- Página web: Ruedarent.com<br>- Redes sociales:<br>@Ruedarent en Facebook, Instagram y Twitter</td><td text-align= "justify">- Página web: WHOOSH.com<br>- Redes sociales:<br>@WHOOSHapp en Facebook, Instagram y Twitter</td><td text-align= "justify">- Página web: Airbnb.com<br>- Redes sociales:<br>@Airbnb en Facebook, Instagram y Twitter</td><td text-align= "justify">- Página web: CityBikeLima.com<br>- Redes sociales:<br>@CityBikeLima en Facebook, Instagram y Twitter</td>
   </tr>
   <tr>
    <td rowspan=4>Análisis SWOT</td><td>Fortalezas</td><td text-align= "justify">- Variedad de vehículos eléctricos par alquilar.<br>- Contribuye a una movilidad urbana sostenible.</td><td text-align= "justify">- Acceso rápido a destinos urbanos en 15 minutos.<br>- Promueve un estilo de vida activo y sostenible</td><td text-align= "justify">- Amplia oferta de alojamientos únicos en todo el mundo.<br>- Experiencias personalizadas para viajeros.</td><td text-align= "justify">- Movilidad sostenible en Miraflores.<br>- Facilita el transporte en bicicleta en la ciudad.</td>
   </tr>
   <tr>
    <td>Debilidades</td><td text-align= "justify">- Dependencia de la disponibilidad y mantenimiento de vehículos eléctricos.<br>- Posible limitación de infraestructura de carga.</td><td text-align= "justify">- Cobertura limitada en áreas menos pobladas.<br>- Dependencia de la precisión de la información de tráfico.</td><td text-align= "justify">- Riesgo de experiencias negativas debido a la falta de estándares uniformes en alojamientos.<br>- Posibles desafíos regulatorios y disputas legales.</td><td text-align= "justify">- Demanda limitada en áreas con infraestructura vial poco adecuada para ciclistas.<br>- Posibles problemas de vandalismo o robo de bicicletas.</td>
   </tr>
   <tr>
    <td>Oportunidades</td><td text-align= "justify">Expansión de flota y colaboraciones para programas de movilidad sostenible.</td><td text-align= "justify">Expansión a nuevas ciudades y mejoras en la aplicación</td><td text-align= "justify">Diversificación de servicios y expansión a mercados emergentes</td><td text-align= "justify">Expansión a más distritos y promoción de eventos de ciclismo.</td>
   </tr>
   <tr>
    <td>Amenazas</td><td text-align= "justify">Competencia de empresas de alquiler de vehículos tradicionales y cambios regulatorios.</td><td text-align= "justify">Competencia de otras aplicaciones de movilidad y cambios imprevistos en los patrones de movilidad urbana.</td><td text-align= "justify">Regulaciones locales y resistencia de residentes a la proliferación de alquileres turísticos.</td><td text-align= "justify">Riesgo de accidentes y falta de apoyo gubernamental para la expansión de la infraestructura ciclista.</td>
   </tr>
</table>
</body>
</html>
...
<b>Características</b></td>
<td align=center>
<b>Propietario de Vehículo</b></td> 
<td align=center>
<b>Usuario que Alquila</b></td> 
   </tr>
	<tr>
		<td ROWSPAN = 3><b>Objetivos</b>
</td> 
      <td>Les llama la atención los vehículos.</td>
      <td>El 80% de los entrevistados indicó que sí les llama la atención este tipo de vehículos, mientras que un 20% indicó que les llama la atención los vehículos mayores, pero no los menores.</td>
      <td>Al 100% de los entrevistados mencionaron que les interesan los alquileres de vehículos.</td>
	</tr>
   <tr>
      <td>Necesitan tener medios de interacción con otros tipos de usuarios.</td>
      <td>El 100%  de los entrevistados ven necesario contar con algún medio de interacción con el Propietario de Vehiculo.</td>
      <td>100% de los entrevistados indicaron que necesitan contar con algún medio de interacción con el Propietario de Vehículo.</td>
	</tr>
   <tr>
      <td>Han utilizado aplicaciones relacionadas con frecuencia.</td>
      ...
      <td>66% de los entrevistados han utilizado redes sociales para publicitar sus vehiculos. El 34% restante hizo uso de las redes sociales anteriormente, pero las dejó por falta de seguidores.</td>
	</tr>
   <tr>
		<td ROWSPAN = 3>
 <b>Subjetivos</b>
</td> 
      <td>A los entrevistados les gustaría que los Propietarios de Vehículos pudieran obtener ganancias por sus vehículos.</td>
      <td>A todos los entrevistados les gustaría obtener ganancias por sus vehículos.</td>
      <td>A todos los entrevistados les pareció una buena idea visualizar vehículos de su interés.</td>
   <tr>
      <td>A los entrevistados les gustaría contar con planes de suscripción.</td>
      <td>A 100% de los entrevistados le gustaría contar con planes de subscripción.</td>
      <td>A 100% de los entrevistados le gustaría contar con planes de subscripción.</td>
	</tr>
      <tr>
      <td>Buscan vehículos relacionados a su área de interés</td>
      <td>Al 80% de los entrevistados les gusta buscar información sobre sus áreas de interés. El otro 20% mencionó que suelen explorar nuevas opciones.</td>
...
El Needfinding es una metodología cualitativa que se enfoca en las opiniones y sentimientos de los usuarios. El objetivo de este método, como su nombre indica, es identificar, buscar, analizar, obtener, rescatar y valorar, en términos sencillos, las necesidades que puedan guiar y orientar el desarrollo y diseño de cualquier proyecto.
...
| User task                              | Propietario de Vehículo                | Usuario que Alquila                     |
| -------------------------------------- | -------------------------------------- | --------------------------------------- |
...
- Usuario (User): Persona que utiliza la aplicación para alquilar o buscar vehículos eléctricos. Se divide en dos categorías:
  - Propietario de Vehículo (Owner): Usuario que ofrece sus vehículos para alquilar a otros usuarios.
...
| ------ | ------------- | ---------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ |
| 1      | US01          | Barra de navegación en la Landing Page                                 | Como usuario quiero un menú para ver las secciones de la aplicación.                                                                                                                                                                                             | 3                        |
...
| 3      | US03          | Sección de nosotros del Landing Page                                   | Como usuario quiero saber quiénes son y que ofrece la aplicación para optar por ellos.                                                                                                                                                                           | 2                        |
| 4      | US04          | Sección de las redes sociales/Footer del Landing Page                  | Como usuario quiero visualizar, en una sección, las redes sociales de la aplicación.                                                                                                                                                                             | 2                        |
| 5      | US05          | Sección de contactos en la Landing Page                                | Como usuario quiero contactar alguna persona para resolver dudas o problemas.                                                                                                                                                                                    | 3                        |
...
| 9      | US09          | Ver vehículos disponibles                                              | Como persona que desea alquilar quiero poder visualizar un filtro para poder encontrar el vehículo adecuado.                                                                                                                                                     | 3                        |
| 10     | US10          | Filtro de búsqueda de vehículos                                        | Como persona que desea alquilar quiero poder visualizar un filtro para poder encontrar el vehículo adecuado.                                                                                                                                                     | 3                        |
...
| 13     | US13          | Sección de testimonios                                                 | Como la persona que desea alquilar, deseo leer testimonios de otros usuarios que han experimentado beneficios al utilizar la plataforma, como su estilo de vida, para sentirme inspirado y tomar decisiones informadas.                                          | 3                        |
...
User Goal: Como propietario de vehículos, deseo iniciar sesión en la aplicación para acceder a la plataforma web para visualizar "Mi Perfil".
...
![Prototype-design](https://i.ibb.co/nLShLJ2/prototype.png)
...
<table style="width:400px; height:100px;"> 
   ...
   <tr>
    ...
    <tr>
     <th> EP2-US06 </th>
     <th colspan="3">Filtro de búsqueda de vehículos para personas que desean alquilar</th>
     <th>W10</th>
     <th>User Bounded Context</th>
     <th>Implementar la búsqueda de vehículos.</th>
     <th>2</th>
     <th>Juan Calisaya</th>
     <th>Done</th> 
   </tr>
    <tr>
     ...
     <tr>
     <th>E2-US08</th>
     <th colspan="3"> Visualización de vehículos para propietarios</th>
     <th>W12</th>
     <th>User Bounded Context</th>
     <th>Visualizar todos los vehículos</th>
     <th>1</th>
     <th>Beth Oneglio</th> 
     <th>Done</th>
   </tr>
    <tr>
     <th>E2-US09</th>
     <th colspan="3">Pago de plan de suscripción</th>
     <th>W13</th>
    ...
    <tr>
     <th>E2-US10</th>
     <th colspan="3">Información de pedido</th>
     <th>W14</th>
     <th>User Bounded Context</th>
     <th>Implementar la información del pedido junto con el botón Paypal.</th>
     <th>3</th>
     <th>David Gallo</th> 
     <th>Done</th>
   </tr>
    <tr>
     <th>E2-US11</th>
     <th colspan="3">Visualización de vehículos para personas que desean alquilar</th>
     <th>W15</th>
     <th>User Bounded Context</th>
     <th>Implementar la visualización de vehículos para un usuario.</th>
     <th>3</th>
     <th>Juan Calisaya</th> 
     <th>Done</th>
   </tr>
    ...
    <tr>
     <th>E3-US12</th>
     <th colspan="3">Personalización de perfil de propietario</th>
     <th>W016</th>
     <th>Content Bounded Context</th>
     <th>Implementar la personalización de perfil de propietario.</th>
     <th>4</th>
     <th>David Gallo</th> 
     <th>Done</th>
   </tr>
    <tr>
     ...
     <th>W19</th>
     <th>User Bounded Context</th>
     <th>Utilizar un servicio para el inicio de sesión.</th>
     <th>5</th>
     <th>Alejandro La Rosa</th> 
     <th>Done</th>
   </tr>
...
En esta sección se presentan las tareas realizadas durante el presente sprint, acompañadas de una captura de pantalla de Trello y el enlace correspondiente al tablero.

Link de Trello: https://trello.com/invite/b/QrkkbMZh/ATTI99d4f743d468b1e75466f74d3aaf80a071515AC7/ruedarent-backlog-tp1

<img src="https://i.ibb.co/HBqRpzQ/image.png"/>
...
| Frontend   | main   | c27a944   | feat/chore: Added publish components and configs                                         | Added publishing components and their settings. | 28/04/2024         |
...
Durante este sprint, se ha completado el desarrollo del frontend de la aplicación web. Para el despliegue, se utilizaron las siguientes herramientas.
...
Aquí está la lista ordenada:
  ...
  <li>Netlify: Una plataforma que automatiza la implementación de sitios web estáticos, lo que nos permitió alojar y desplegar nuestra aplicación web.</li>
...
| Alumno                         | Actividad                                                                                                                                                                                        |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Calisaya Sánchez, Juan Jesús   | Se encargó de la implementación de la búsqueda de vehículos tanto para la versión móvil como de escritorio. Además, contribuyó al desarrollo de la visualización de los vehículos.               |
| Gallo Quintana, David Ivanoff  | Se encargó de implementar la funcionalidad de pedido en la página web, creando componentes y diseñando la interfaz para propietarios de vehículos, tanto en su versión móvil como de escritorio. |
| Huarcaya Quispe, Niurka Lucero | Se encargó de implementar las recomendaciones de vehículos y la visualización de vehículos adicionales en la página web, tanto en su versión móvil como de escritorio.                           |
| La Rosa Rodríguez, Alejandro   | Se encargó de implementar el inicio de sesión (login) y el registro (register) en la página web, tanto en su versión móvil como de escritorio.                                                   |
| Oneglio De Paz, Beth Shantal   | Se encargó de implementar las secciones del capítulo 5 y la previsualización, así como la adición del perfil del usuario que alquila, tanto en su versión móvil como de escritorio.              |
...
| Rum1z             | Gallo Quintana, David Ivanoff  |
...
<table>
  ...
  <tr>
   <th style="text-align:center;"> <strong> User Bounded Context </strong> </th>
    <th style="text-align:center;"> <strong> api/v1/user </strong> </th>
  ...
  <tr>
   <th style="text-align:center;"> <strong> Vehicle Bounded Context </strong> </th>
    ...
    <th> <img src="https://i.ibb.co/ZT3KYWX/vehicle.jpg" alt="vehicle"> </th>
  </tr>
...
- Entre las estrategias identificadas para mejorar la experiencia del usuario y aumentar la participación y retención, se encuentran la simplificación del proceso de registro, la mejora de la colaboración creativa, el resaltado de las mejores obras, la provisión de métricas claras sobre el rendimiento y la implementación de un sistema de suscripción premium. Además de estas características, nuestro proyecto incluye una variedad de elementos, como el diseño de la interfaz de usuario, el desarrollo de funciones específicas, la implementación de estrategias de marketing y la evaluación continua del rendimiento y la retroalimentación de los usuarios.
...
https://upcedupe-my.sharepoint.com/:v:/g/personal/u202213423_upc_edu_pe/EdfKuAu_FmhLvmRUTeSGSMwBz16iFJsgijOhFVd8zw1FyQ?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=8UUpma
